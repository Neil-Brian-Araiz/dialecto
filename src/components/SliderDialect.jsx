...
const array = [
  { pic: DiaclectImg, btnLabel: 'Play now!', label: 'Waray', nav: '/dialecto/animal-category', bgColor: '#FFD700', desc: "The Waray language is part of the Austronesian language family and is spoken throughout Samar Island, with some variations between the dialects of Eastern, Northern, and Western Samar. They are the most culturally conservative of the Visayans.", showPopup: false },
